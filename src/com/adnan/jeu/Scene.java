...
import com.adnan.affichage.CompteARebours;
import com.adnan.affichage.Score;
import com.adnan.audio.Audio;
import com.adnan.objets.Bloc;
import com.adnan.objets.Objet;
import com.adnan.objets.Piece;
import com.adnan.objets.TuyauRouge;
import com.adnan.personnages.Champ;
import com.adnan.personnages.Mario;
import com.adnan.personnages.Tortue;
...
public class Scene extends JPanel {
	...
	public Champ champ8;
	public Champ champ9;
	public Champ champ10;
	
	public Tortue tortue0;
	...
	public Tortue tortue10;
	public Tortue tortue11;
	...
	public Scene(){		
		...
		ImageIcon image=new ImageIcon(getClass().getResource("/images/mario2.png"));
    Main.fenetre.setIconImage(image.getImage());
		this.dx = 0;
		this.xPos = -1;
		this.ySol = 293; // sol initial
		this.hautPlafond = 0; //plafond initial
		this.xFond1 = -50; // L'image de fond d�passe des 2 cotes de la fen�tre.
		this.xFond2 = 750;
		this.ok = true;
		...
		tuyauRouge0 = new TuyauRouge(500, 230);
		...
		Audio.playSound("/audio/Super-Mario-Bros.wav");
		

		bloc1 = new Bloc(400, 180);
		bloc2 = new Bloc(800, 180);
		bloc3 = new Bloc(1200, 180);
		bloc4 = new Bloc(1270, 170);
		bloc5 = new Bloc(1340, 160);
		bloc6 = new Bloc(2000, 180);
		bloc7 = new Bloc(2600, 160);
		bloc8 = new Bloc(2650, 180);
		bloc9 = new Bloc(3500, 160);
		bloc10 = new Bloc(3550, 140);
		bloc11 = new Bloc(4000, 170);
		bloc12 = new Bloc(4200, 200);
		bloc13 = new Bloc(4300, 210);
		
		champ1 = new Champ(800, 263);
		champ2 = new Champ(1000, 263);
		champ3 = new Champ(1400, 263);
		champ4 = new Champ(1900, 263);
		champ5 = new Champ(2100, 263);
		champ6 = new Champ(2400, 263);
		champ7 = new Champ(3200, 263);
		champ8 = new Champ(3500, 263);
		champ9= new Champ(3700, 263);
		champ10 = new Champ(4500, 263);


		tortue0 = new Tortue(450, 243);
		tortue1 = new Tortue(550, 243);
		tortue2 = new Tortue(950, 243);
		tortue3 = new Tortue(1500, 243);
		tortue4 = new Tortue(1800, 243);
		tortue5 = new Tortue(2400, 243);
		tortue6 = new Tortue(3000, 243);
		tortue7 = new Tortue(3600, 243);
		tortue8 = new Tortue(3800, 243);
		tortue9 = new Tortue(4100, 243);
		tortue10 = new Tortue(4200, 243);
		tortue11 = new Tortue(4400, 243);
		
		piece1 = new Piece(402, 145);
		piece2 = new Piece(802, 140);
		piece3 = new Piece(1202, 140);
		piece4 = new Piece(1272, 95);
		piece5 = new Piece(1342, 40);
		piece6 = new Piece(1650, 145);
		piece7 = new Piece(2650, 145);
		piece8 = new Piece(3000, 135);
		piece9 = new Piece(3400, 125);
		piece11 = new Piece(3800,100);
		piece10 = new Piece(4200, 145);
		piece11 = new Piece(4600, 40);

		mario = new Mario(300, 243);
		
        tabObjets = new ArrayList<Objet>();
		this.tabObjets.add(this.tuyauRouge0);	
		...
		this.tabObjets.add(this.bloc13);
		...
		this.tabChamps.add(this.champ9);
		this.tabChamps.add(this.champ10);
		...
		this.tabTortues.add(this.tortue10);
		this.tabTortues.add(this.tortue11);
		this.tabTortues.add(this.tortue0);
		...
		police = new Font("ARMY", Font.PLAIN, 18);
	...
	private boolean partieGagnee(){		
		if(this.compteARebours.getCompteurTemps() > 0){
			if(this.mario.isVivant() == true){
				if(this.score.getNbrePieces() == 11){ 
					if(this.xPos > 4400){
						if(this.ok == true){
	...
	public void paintComponent(Graphics g) {
	    ...
	    // Mise � jour du score
	    g2.drawString(this.score.getNbrePieces() + " piece(s) sur " + this.score.getNBRE_TOTAL_PIECES(), 530, 25);
	    
	    // Fin de partie
	    if(this.finDePartie() == true){
	    	Font policeFin = new Font("Arial", Font.BOLD, 50);
            g2.setFont(policeFin);
	        if(this.partieGagnee() == true){g2.drawString("Vous avez gagne !!", 120, 180);}
